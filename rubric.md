...
PART 1 pt: The `Cafe` class keeps the inventory up to date, based on sales

PART 1 pt: The `Cafe` class uses the `restock(...)` method to avoid running out of inventory.
